...
WCHAR		g_szAppTitle[]	= L"Direct3D 11 Sample13";
WCHAR		g_szWndClass[]	= L"D3D11S13";
...
HRESULT Render(void)
{
	...
	XMMATRIX matX = XMMatrixRotationX(rotate);

	XMStoreFloat4x4(&g_cbCBuffer.World, XMMatrixTranspose(matTrans * matScale * matY * matX));
